...
const GarantieSection = () => (
  <section className="py-12 bg-foreground">
    <div className="container mx-auto px-4 max-w-3xl">
      <div className="flex flex-col md:flex-row items-center gap-6 bg-primary-foreground/5 border border-primary-foreground/10 rounded-2xl p-8">
        ...
        <div className="text-center md:text-left">
          <div className="flex items-center gap-3 justify-center md:justify-start mb-2">
            ...
            <span className="bg-accent text-accent-foreground text-xs font-bold px-3 py-1 rounded-full uppercase">
